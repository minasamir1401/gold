        ...
        >
            ...
            <div className={`flex items-start justify-between mb-8 ${!isRTL && "flex-row-reverse"}`}>
                <div className={cn(
                    ...
                    variant === "gold" ? "bg-gold-500/15 text-gold-500 shadow-[0_0_20px_rgba(255,215,0,0.15)]" :
                        variant === "blue" ? "bg-primary-500/15 text-primary-500 shadow-[0_0_20px_rgba(37,99,235,0.15)]" :
            ...
            <div className={`space-y-1 ${isRTL ? "text-right" : "text-left"}`}>
                <h3 className="text-slate-500 dark:text-slate-400 text-[10px] sm:text-sm font-bold uppercase tracking-wider">{title}</h3>
            ...
            <div className={`mt-8 pt-5 border-t border-slate-100 dark:border-slate-800 flex items-center justify-between ${!isRTL && "flex-row-reverse"}`}>
                <div className={`flex items-center gap-2 text-[11px] font-bold text-slate-400 ${!isRTL && "flex-row-reverse"}`}>
